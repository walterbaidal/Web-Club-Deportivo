		...
		<div class="mt-4 card mb-4">
			<div class="card-body">	
				...
				<div class="container-fluid text-center"> 
														...
														<label class="btn btn-outline-primary btn-block">
									    					...
									    					<div class="float-right">
									    						<?php 
									    							if($user[2] == 1){
									    						?>	
									    							<img src="CDI/CDI/8 - Plantilla - Entrenador/SancionNegro.png" width="20" alt="">
									    						<?php  
									    							} elseif ($user[3] == 1) {
									    						?>
					...
					<img class="float-right" src="CDI/CDI/Leyenda/plantilla.png" height="40" class="img-fluid">
					<br>	<br>
					...
					<div class="text-right">
						<form action="crear_plantilla_script.php" method="post">
							<button type="submit"  class="btn btn-primary"> 
								Crear plantilla
								<img src="CDI/CDI/Menu/Plantilla.png" class="d-inline-block align-items-center align-img"  height="20" alt="">
							</button>
						</form>
					</div>	
