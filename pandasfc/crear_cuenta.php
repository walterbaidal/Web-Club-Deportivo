		    ...
		    <div class="modal-content">
	        	<div class="modal-header">
		      	...
		      	<div class="modal-body">
		        	<form action="registro_correcto.php">
						...
						<div class="form-group">
				    		...
				    		<input type="text" class="form-control text-center" id="inputNombre" placeholder="Nombre" maxlength="30" required>
						 </div>		

				  		<div class="form-group">
			  				<label for="inputApellido">Apellidos *</label>
			  				<input type="text" class="form-control text-center" id="inputApellido" placeholder="Apellidos" maxlength="30" required>
				  		</div>

				  		<div class="form-group">	
				  			<label for="inputCorreo">Correo electrónico *</label>
				  			<input type="email" class="form-control text-center" id="inputCorreo" placeholder="Correo electrónico" required>
						 </div>

						<div class="form-group">
				  			<label for="inputContrasena">Contraseña *</label>
				  			<input type="password" class="form-control text-center" id="inputContrasena" maxlength="16" minlength="8" placeholder="Contraseña" required>
						...
						<div class="form-group">
				  			...
				  			<input type="text" class="form-control text-center" id="inputNumeroLicencia" placeholder="Número de licencia" maxlength="9" required>
						</div>
						...
						<div class="text-center">
				  		...
				  		<div class="text-center">
				  			<a class="btn btn-primary" href="registro_correcto.php" role="button">Registrarse</a>
				  		</div>
					</form>
		     	 </div>
