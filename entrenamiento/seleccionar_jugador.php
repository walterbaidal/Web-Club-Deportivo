		...
		<div class="mt-4 card">
			<div class="card-body">	
				...
				<div class="text-right">
					<button type="submit"  class="btn btn-primary">Seleccionar fecha y tipo <img src="../CDI/CDI/6 - Entrenamiento/Siguiente2.png" class="d-inline-block align-items-center" width="20" height="20" alt=""></button>
				</div>	
			</form>
