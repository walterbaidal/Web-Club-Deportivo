								...
								<form action="preparar_entrenamiento.php" method="post">
									...
									<div class="float-left">
									  	<a href="javascript:history.back()" class="btn btn-primary">
											...
											Volver a seleccionar fecha y tipo
										</a>
									</div>
									<div class="text-right">
										<button type="submit"  class="btn btn-primary">Seleccionar ejercicio <img src="../CDI/CDI/6 - Entrenamiento/Siguiente2.png" class="d-inline-block align-items-center" width="20" height="20" alt=""></button>
									</div>
								</form>
							</div>
						</div>
