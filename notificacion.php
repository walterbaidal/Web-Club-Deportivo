					...
					<div class="col-md-10">
						...
						<div class="tab-content" id="nav-tabContent">
					      	<div class="tab-pane fade" id="list-redactar" role="tabpanel" aria-labelledby="list-redactar-list">
					      		<form action="enviar_mensaje_script.php" method="POST" autocomplete="off">
								  	<div class="form-group autocomplete">
									    <label for="exampleFormControlInput1">Correo electrónico*</label>
		    							<input id="correo" type="email" name="correo" class="form-control" id="exampleFormControlInput1" placeholder="nombre@pandasfc.com" required>
								  	</div>

								  	<div class="form-group">
									    <label for="asunto">Asunto*</label>
		    							<input id="correo" type="text" name="asunto" class="form-control" id="asunto"  required>
								  	</div>
									 	 	
	  								<div class="form-group">
									    <label for="mensaje_contenido">Mensaje*</label>
									    <textarea class="form-control" name="mensaje" id="mensaje_contenido" rows="6" required></textarea>
								  	</div> 	
					      	...
					      	<div class="tab-pane fade show active" id="list-todos" role="tabpanel" aria-labelledby="list-todos-list">
					      		<img class="float-right" src="CDI/CDI/Leyenda/notificacion.png" class="img-fluid">
								<br><br><br>
					      		<table class="table table-bordered table-hover">
								  	...
								  	<tbody>
								    	<?php 
						 				...
						 				?>
						 								<tr>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo "204"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $i; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo "204"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[1]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo "204"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[2]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo "204"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[3]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo "204"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[4]; ?></td>
														      	<td>
														      		
								    									<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#confirmationModal<?php  echo "1040"; echo $user[0]; ?>">
														    				<img src="CDI/CDI/4 - Calendario - Entrenador/Borrar.png"  width="18" height="18"/>
														    			</button>

														    			<div class="modal fade" id="confirmationModal<?php echo "1040"; echo $user[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																		        ...
																		        ¿Estás seguro que deseas borrar este mensaje?
																			      ...
																			      <div class="modal-footer">
																			      	<form action="borrar_mensaje_script.php" method="post">
																				        ...
																				        <button type="button" class="btn btn-danger" data-dismiss="modal"><img src="CDI/CDI/8 - Plantilla - Entrenador/No disponible.png" class="d-inline-block align-items-center align-img" width="13" height="13" alt=""> No</button>
					    								...
					    								<div class="modal fade" id="msgModal<?php echo "204"; echo $user[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					      		...
					      		<table class="table table-bordered table-hover">
								  	...
								  	<tbody>
								    	<?php 
						 				...
						 				?>
						 								<tr>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $i; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[1]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[2]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[3]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[4]; ?></td>
														      	<td>
														      		<form action="borrar_mensaje_script.php" method="post">
														    			...
														    			<div class="modal fade" id="confirmationModal<?php echo $i; echo "13"; echo $user[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
																		  <div class="modal-dialog modal-sm" role="document">
																		    <div class="modal-content" style="margin-top: 50%;">
																		      ...
																		      <div class="modal-footer">
																		        <button type="button" class="btn btn-danger" data-dismiss="modal"><img src="CDI/CDI/8 - Plantilla - Entrenador/No disponible.png" class="d-inline-block align-items-center align-img" width="13" height="13" alt=""> No</button>
																		        <button type="submit" class="btn btn-success"><img src="CDI/CDI/8 - Plantilla - Entrenador/DisponibleBlanco.png" class="d-inline-block align-items-center align-img" width="13" height="13" alt=""> Si</button>
																		      </div>
																		    </div>
																		  </div>
																		</div>
					      		...
					      		<table class="table table-bordered table-hover">
								  	...
								  	<tbody>
								    	<?php 
						 				...
						 				?>
						 								<tr>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>" data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $i; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[1]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[2]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[3]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "0"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[4]; ?></td>
					      		...
					      		<table class="table table-bordered table-hover">
								  	...
								  	<tbody>
								    	<?php 
						 				...
						 				?>
						 								<tr>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "20"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $i; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "20"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[1]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "20"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[2]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "20"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[3]; ?></td>
													      	<td data-toggle="modal" data-id="1" data-target="#msgModal<?php echo $i; echo "20"; echo $user[0]; ?>" class="<?php if ($user[6] == 0) { echo "table-warning"; } else { echo "table-success"; }?>"><?php echo $user[4]; ?></td>
														      	<td>
														      		<form action="borrar_mensaje_script.php" method="post">
