			    ...
			    <?php if ( $_SESSION['tipo_usuario'] == 1 ) { ?>
				    ...
				    select: function(date, time, allDay)
				    {
				    	if (confirm("¿Deseas crear un nuevo evento?")){
							...
							while (title == "" || title == null) {
							  title = prompt("Titulo (Este campo no puede estar vacio) :");
							}
							var type = prompt("Codigo evento* :" + "\n" + "1. Cena" + "\n" + "2. Fiesta" + "\n" + "3. Reunion" + "\n" + "4. Liga" + "\n" + "5. Copa" + "\n" + "6. Torneo");
							while (type == "" || type == null || type < 1 || type > 6 || isNaN(type)) {
							  type = prompt("Codigo evento (Este campo no puede estar vacio):" + "\n" + "1. Cena" + "\n" + "2. Fiesta" + "\n" + "3. Reunion" + "\n" + "4. Liga" + "\n" + "5. Copa" + "\n" + "6. Torneo");
							}
							var time = prompt("Hora formato HH:mm:ss");
							while (time == "" || time == null) {
							  time = prompt("Hora formato HH:mm:ss (Este campo es obligatorio)");
							}
							if(title && type && time)	{ 
				    ...
				    eventDrop: function(event) {
				    	if (confirm("¿Seguro que quieres editar este evento?")){
							...
							while (title == "" || title == null) {
							  title = prompt("Titulo (Este campo no puede estar vacio) :", event.title);
							}
							...
							while (time == "" || time == null) {
							  time = prompt("Hora formato HH:mm:ss (Este campo es obligatorio)", event.time);
							}
	...
	<div class="container">
		...
		<div class="mt-4 card mb-4">
			<div class="container-fluid">
					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					      	<div class="row">
					      		<div class="col-md-6"><b>Creacion: </b>Para crear <b>eventos</b>, pulsa sobre cualquier día del calendario y recibirás una alerta si deseas crearlo.  </div>
					      		<div class="col-md-6"><img src="CDI/CDI/Guia/dias.png"  width="200" alt=""></div>
					      	</div>
					        	En caso de que no lo desees para ese día, se puede pulsar sobre <b>Cancelar</b>.
					       <br><hr>
							
					   
					        <b>Visualización y borrado: </b>Para ver la información de un evento, simplemente pulsa sobre él. Donde además tendrás la opción de borrar dicho evento si lo deseas.
								<br><br>
					        <div class="text-center"><img src="CDI/CDI/Guia/info.png"  width="350" alt=""></div>
								<hr>
					        <div class="row">
					        	<div class="col-md-6"><b>Edición: </b>Si quieres cambiar un evento de día, simplemente arrastralo al nuevo día deseado, donde además tendrás la opción de cambiar las caracterísiticas del evento.</div>
					      ...
					      <div class="modal-footer">
					        <button type="button" class="btn btn-primary" data-dismiss="modal">
					        	<img src="CDI/CDI/3 - Menú principal - Jugador/Votar.png" class="d-inline-block align-items-center align-img" width="20" height="20" alt="">
						        De acuerdo
						    </button>
					      </div>
					    </div>
				...
				<?php } ?>
				<div class="card-body">
					<div class="float-right"> <img class="float-right" src="CDI/CDI/Leyenda/calendario.png" class="img-fluid" width="80%"> </div>
					<div id="calendar"></div>
				</div>	
			</div>
		</div>
